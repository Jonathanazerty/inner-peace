...
export const ModalRelax = ( { showModal, setShowModal} , props) => {
...
{  showModal ? 
        <Background ref={modalRef} onClick={closeModal}>
            <ModalWrapper>
                <ModalImg src={relax} alt='relax'/>
                <ModalContent>
                    {data[5].RelaxText1}<br></br>
                    {data[5].RelaxText2}<br></br>
                    {data[5].RelaxText3}<br></br>
                    {data[5].RelaxText4}<br></br>
                    {data[5].RelaxText5}
                </ModalContent>
                <CloseModalButton
