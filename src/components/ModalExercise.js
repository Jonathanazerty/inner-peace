...
import exercise from '../images/dance.jpg';
...
export const ModalExercise = ( { showModal, setShowModal} , props) => {
    console.log(props)
    console.log(data)
...
{  showModal ? 
        <Background ref={modalRef} onClick={closeModal}>
            ...
            <ModalWrapper>
                <ModalImg src={exercise} alt='exercise'/>
                <ModalContent>
                    {/* <div>
                        <ul>
                    ...
                    {data[8].ExerciseText1}<br></br>
                    {data[8].ExerciseText2}<br></br>
                    {data[8].ExerciseText3}<br></br>
                    {data[8].ExerciseText4}<br></br>
                    {data[8].ExerciseText5}
                </ModalContent>
                <CloseModalButton
