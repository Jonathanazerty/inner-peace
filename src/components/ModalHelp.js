...
import help from '../images/therapy.jpg';
...
export const ModalHelp = ( { showModal, setShowModal} , props) => {
...
{  showModal ? 
        <Background ref={modalRef} onClick={closeModal}>
            <ModalWrapper>
                <ModalImg src={help} alt='help'/>
                <ModalContent>
                    {data[10].HelpText1}<br></br>
                    {data[10].HelpText2}<br></br>
                    {data[10].HelpText3}
                </ModalContent>
                <CloseModalButton
